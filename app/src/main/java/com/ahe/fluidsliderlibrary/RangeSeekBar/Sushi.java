...
public class Sushi extends FrameLayout {
    ...
    public static class Settings {
        ...
        private int colorBackground = Color.parseColor("#000000");//Color.parseColor("#cccccc");
        private int textColor = Color.parseColor("#000000");//Color.parseColor("#6E6E6E");
        ...
        private int foregroundColor = Color.parseColor("#000000");//Color.parseColor(/*"#007E90"*/"#00000000");
